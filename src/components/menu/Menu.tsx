  ...
  return (
    <div className=" min-h-screen text-white p-6">
      ...
      <div className="flex items-center mb-4">
        ...
        <a href="#" className="py-1 text-sm">Dashboard</a>
      </div>
      <div className="flex items-center mb-12">
        <FaGraduationCap className="mr-2" /> {/* Graduation cap icon */}
        <a href="#" className="py-1 text-sm">Academy Management</a>
      </div>
      ...
      <div className="flex items-center mb-4">
        ...
        <a href="#" className="py-1 text-sm">Students</a>
      </div>
      <div className="flex items-center mb-4">
        <FaMoneyBillAlt className="mr-2" /> {/* Money bill icon */}
        <a href="#" className="py-1 text-sm">Fee Payments</a>
      </div>
      <div className="flex items-center mb-4">
        <FaSearch className="mr-2" /> {/* Search icon */}
        <a href="#" className="py-1 text-sm">Enquiries</a>
      </div>
      <div className="flex items-center mb-4">
        <FaUsersCog className="mr-2" /> {/* Users cog icon */}
        <a href="#" className="py-1 text-sm">Coaches</a>
      </div>
      <div className="flex items-center mb-4">
        <FaCalendarAlt className="mr-2" /> {/* Calendar icon */}
        <a href="#" className="py-1 text-sm">Schedule</a>
      </div>
    </div>
  );
}
