    ...
    <div className="flex items-center w-full p-3">
      ...
      <div className="flex items-center justify-between flex-1">
        ...
        <div className="pr-2 flex">
            <div className="pr-2">
              <FaCog size={50} className="text-gray-600 bg-gray-300 rounded-full p-2" />
            </div>
            <div className="pr-2">
              <FaBell size={50} className="text-gray-600 bg-gray-300 rounded-full p-2" />
            </div>
          </div>
        <div className="text-right text-xl flex">
          <div className="px-4">
            <img src="src/assets/dplogo.png" alt="DP Logo" style={{ width: '50px' }} />
          </div>
